...
import ModalFreeSpinAward from './src/components/ModalFreeSpinAward.svelte';
...
export { messagesMap, i18nDerived, Modals, GameVersion, GlobalStyle, ModalFreeSpinAward };
