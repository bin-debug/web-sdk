...
<Sprite key="bgFrame" anchor={0.5} x={bl().x} y={bl().y} width={bl().width * 1.1087} height={bl().height * 1.1088} zIndex={-2} />
...
<Sprite
	...
	width={bl().width * 1.2905 * frameScale}
	height={bl().height * 1.2918 * frameScale}
	zIndex={0}
/>
