...
<Sprite key="bgFrame" anchor={0.5} x={bl().x} y={bl().y} width={bl().width * 1.1305} height={bl().height * 1.1342} zIndex={-2} />
...
<Sprite
	...
	y={bl().y + bl().height * 0.0139}
	width={bl().width * 1.3367 * frameScale}
	height={bl().height * 1.3740 * frameScale}
	zIndex={0}
/>
