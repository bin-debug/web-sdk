<script lang="ts">
	...
	// Falls back only when no spec features are supplied (patchLayoutChrome
	// always passes real ones for a generated game). Card language matches the
	// Buy Bonus screen so the two feel like one system.
