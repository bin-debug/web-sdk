...
<Sprite key="bgFrame" anchor={0.5} x={bl().x} y={bl().y} width={bl().width * 1.1531} height={bl().height * 1.1823} zIndex={-2} />
...
<Sprite
	...
	y={bl().y + bl().height * 0.0022}
	width={bl().width * 1.3846 * frameScale}
	height={bl().height * 1.4511 * frameScale}
	zIndex={0}
/>
