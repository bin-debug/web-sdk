...
<Sprite key="bgFrame" anchor={0.5} x={bl().x} y={bl().y} width={bl().width * 1.1499} height={bl().height * 1.2681} zIndex={-2} />

<!-- ornate frame: hole aligned to the board via measured insets -->
<Sprite
	key="reelFrame"
	anchor={0.5}
	x={bl().x + bl().width * 0.0004}
	y={bl().y + bl().height * 0.0030}
	width={bl().width * 1.3786 * frameScale}
	height={bl().height * 1.6347 * frameScale}
	zIndex={0}
/>
