...
<Sprite key="bgFrame" anchor={0.5} x={bl().x} y={bl().y} width={bl().width * 1.0716} height={bl().height * 1.1098} zIndex={-2} />
...
<Sprite
	...
	y={bl().y + bl().height * -0.0011}
	width={bl().width * 1.2118 * frameScale}
	height={bl().height * 1.2951 * frameScale}
	zIndex={0}
/>
