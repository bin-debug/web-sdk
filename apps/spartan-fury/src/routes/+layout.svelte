<script lang="ts">
	...
	const introFeatures = [{"icon":"⚔️","title":"Scatter Wins","subtitle":"Land 3+ Scatters anywhere to trigger Free Spins"},{"icon":"🛡️","title":"Wild Warriors","subtitle":"Wilds substitute for all symbols to forge winning lines"},{"icon":"💰","title":"5,000× Max Win","subtitle":"Fight for the biggest battle payout"}];
...
{#if !introVisible && !bonusModalOpen}
	<div class="top-bar">
		<div class="tb-left">
			...
			<span class="tb-name">Spartan Fury</span>
		</div>
