...
<Sprite key="bgFrame" anchor={0.5} x={bl().x} y={bl().y} width={bl().width * 1.1245} height={bl().height * 1.1455} zIndex={-2} />
...
<Sprite
	...
	y={bl().y + bl().height * 0.0015}
	width={bl().width * 1.3239 * frameScale}
	height={bl().height * 1.3718 * frameScale}
	zIndex={0}
/>
