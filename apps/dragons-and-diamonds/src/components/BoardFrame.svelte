...
<Sprite key="bgFrame" anchor={0.5} x={bl().x} y={bl().y} width={bl().width * 1.1322} height={bl().height * 1.1466} zIndex={-2} />
...
<Sprite
	...
	y={bl().y + bl().height * 0.0099}
	width={bl().width * 1.3413 * frameScale}
	height={bl().height * 1.3919 * frameScale}
	zIndex={0}
/>
