...
<Sprite key="bgFrame" anchor={0.5} x={bl().x} y={bl().y} width={bl().width * 1.1007} height={bl().height * 1.1024} zIndex={-2} />

<!-- ornate frame: hole aligned to the board via measured insets -->
<Sprite
	key="reelFrame"
	anchor={0.5}
	x={bl().x + bl().width * 0.0005}
	y={bl().y + bl().height * 0.0034}
	width={bl().width * 1.2744 * frameScale}
	height={bl().height * 1.2843 * frameScale}
	zIndex={0}
/>
