...
<Sprite key="bgFrame" anchor={0.5} x={bl().x} y={bl().y} width={bl().width * 1.0806} height={bl().height * 1.0905} zIndex={-2} />
...
<Sprite
	...
	width={bl().width * 1.2319 * frameScale}
	height={bl().height * 1.2528 * frameScale}
	zIndex={0}
/>
