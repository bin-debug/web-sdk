...
<Sprite key="bgFrame" anchor={0.5} x={bl().x} y={bl().y} width={bl().width * 1.0679} height={bl().height * 1.1659} zIndex={-2} />

<!-- ornate frame: hole aligned to the board via measured insets -->
<Sprite
	key="reelFrame"
	anchor={0.5}
	x={bl().x + bl().width * -0.0003}
	y={bl().y + bl().height * 0.0030}
	width={bl().width * 1.2046 * frameScale}
	height={bl().height * 1.4181 * frameScale}
	zIndex={0}
/>
