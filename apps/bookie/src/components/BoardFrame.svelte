...
<Sprite key="bgFrame" anchor={0.5} x={bl().x} y={bl().y} width={bl().width * 1.1220} height={bl().height * 1.1271} zIndex={-2} />
...
<Sprite
	...
	width={bl().width * 1.3187 * frameScale}
	height={bl().height * 1.3306 * frameScale}
	zIndex={0}
/>
