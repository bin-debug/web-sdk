...
<Sprite key="bgFrame" anchor={0.5} x={bl().x} y={bl().y} width={bl().width * 1.0837} height={bl().height * 1.0837} zIndex={-2} />
...
<Sprite
	...
	y={bl().y + bl().height * -0.0005}
	width={bl().width * 1.2386 * frameScale}
	height={bl().height * 1.2386 * frameScale}
	zIndex={0}
/>
