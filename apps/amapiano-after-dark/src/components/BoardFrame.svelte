...
<Sprite key="bgFrame" anchor={0.5} x={bl().x} y={bl().y} width={bl().width * 1.2376} height={bl().height * 1.2190} zIndex={-2} />
...
<Sprite
	...
	y={bl().y + bl().height * 0.0000}
	width={bl().width * 1.5638 * frameScale}
	height={bl().height * 1.5244 * frameScale}
	zIndex={0}
/>
