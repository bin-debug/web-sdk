...
<Sprite key="bgFrame" anchor={0.5} x={bl().x} y={bl().y} width={bl().width * 1.1446} height={bl().height * 1.2428} zIndex={-2} />
...
<Sprite
	...
	y={bl().y + bl().height * 0.0046}
	width={bl().width * 1.3675 * frameScale}
	height={bl().height * 1.5845 * frameScale}
	zIndex={0}
/>
