...
<Sprite key="bgFrame" anchor={0.5} x={bl().x} y={bl().y} width={bl().width * 1.1727} height={bl().height * 1.1713} zIndex={-2} />
...
<Sprite
	...
	width={bl().width * 1.4262 * frameScale}
	height={bl().height * 1.4232 * frameScale}
	zIndex={0}
/>
