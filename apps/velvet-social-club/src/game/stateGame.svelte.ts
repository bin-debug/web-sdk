...
export const stateGame = $state({
	boardCenterY: null as number | null,
	board,
...
export const setBoardCenterY = (y: number | null) => { stateGame.boardCenterY = y; };

const boardLayout = () => ({
	x: stateLayoutDerived.mainLayout().width * 0.5,
	y: stateGame.boardCenterY ?? stateLayoutDerived.mainLayout().height * (stateLayoutDerived.layoutType() === 'portrait' ? 0.43 : 0.5),
	anchor: { x: 0.5, y: 0.5 },
