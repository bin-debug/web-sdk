...
<Sprite key="bgFrame" anchor={0.5} x={bl().x} y={bl().y} width={bl().width * 1.1040} height={bl().height * 1.1041} zIndex={-2} />
...
<Sprite
	...
	width={bl().width * 1.2806 * frameScale}
	height={bl().height * 1.2818 * frameScale}
	zIndex={0}
/>
